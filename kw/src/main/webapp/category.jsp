            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-8">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination">
                            <li>
                                <a href="${pageContext.request.contextPath}/item//queryPageByCid?cid=${itemCat.cid}&p=${pageInfo.prePage}" aria-label="Previous">
                                    <span aria-hidden="true">&laquo;</span>
                                </a>
                            </li>
                            <c:forEach begin="1" end="${pageInfo.totalPages}" step="1" var="i">
                                <li ${pageInfo.currentPage==i?"class='active'":" "} ><a href="${pageContext.request.contextPath}/item//queryPageByCid?cid=${itemCat.cid}&p=${i}">${i}</a></li>
                            </c:forEach>
                            <li>
                                <a href="${pageContext.request.contextPath}/item//queryPageByCid?cid=${itemCat.cid}&p=${pageInfo.nextPage}" aria-label="Next">
