    ...
    <div class="row text-center goods-list">
        ...
        <c:forEach items="${rm_items}" var="item">
            <div class="col-md-4 col-xs-4">
                <a class="thumbnail" href="${pageContext.request.contextPath}/item/detail?id=${item.id}"> <img class="img-responsive " src="${pageContext.request.contextPath}/upload/${item.image}" />
