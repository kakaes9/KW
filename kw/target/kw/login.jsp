...
<!--登录区域-->
<div class="container-fluid" style="height:460px;background: url('${pageContext.request.contextPath}/img/loginbg.jpg') no-repeat;">
    <div class="row">
        <div class="col-md-7">
        </div>
        <div class="col-md-5">
                    ...
                    <form class="form-horizontal"  action="${pageContext.request.contextPath}/user/login" method="post" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4" style="padding: 0;">
                                <img id="showCode" width="100" src="${pageContext.request.contextPath}/HappyCaptchaServlet" />
                            </div>
                            <script>
                                //页面初始化
                                $(function (){
                                    ...
                                    $("#showCode").click(function (){
                                        ...
                                        //设置图片src属性
                                        $(this).attr("src","${pageContext.request.contextPath}/HappyCaptchaServlet?=d"+date.getTime());
                                    })
                                });
                            </script>
                        </div>
