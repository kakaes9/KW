...
<footer class="footer">
    <div class="container-fulid">
        <!--服务栏-->
        <div class="row fuwubar" >
            <div class="col-md-3 col-xs-2">
            </div>
            <div class="col-md-2 col-xs-3 ">
                <span class="fw">7</span>
                <span class="hidden-xs">7天无理由退换货</span>
            </div>
            <div class="col-md-2 col-xs-3 ">
                <span class="fw">正</span>
                <span class="hidden-xs">100%官方正品</span>
            </div>
            <div class="col-md-5 col-xs-4 ">
                <span class="fw">免</span>
                <span class="hidden-xs">全场每单满199元包邮</span>
            </div>
        </div>
        <!--帮助栏-->
        <div class="row helperbar  hidden-xs hidden-sm">
    ...
    <div class="container">
        ...
        <div class="row foot">
            <div class="col-md-4 col-xs-2 ">
                <img title="行百里者半九十 专注你的紧要几步" class="img-responsive pull-right" src="${pageContext.request.contextPath}/img/new_logo.png" />
            </div>
            <div class="col-md-8 col-xs-10 foot1">
                Copyright (C) 1998 – 2021 Tencent. All Rights Reserved.百里半 版权所有
                <img src="${pageContext.request.contextPath}/img/bussiness.png" alt="">
            </div>
